    ...
    Column(
        ...
        SettingsGroupCard(title = stringResource(R.string.setting_subgroup_community)) {
            SettingsItemRow(
                ...
                subtitle = stringResource(R.string.setting_source_code_desc),
                icon = Icons.Rounded.Code,
                showDivider = true,
                onClick = {}
            )
            SettingsItemRow(
                title = stringResource(R.string.setting_support_project),
                subtitle = stringResource(R.string.setting_support_project_desc),
        ...
        SettingsGroupCard(title = stringResource(R.string.setting_subgroup_support)) {
            SettingsItemRow(
                ...
                subtitle = stringResource(R.string.setting_faq_desc),
                icon = Icons.AutoMirrored.Rounded.HelpOutline,
                showDivider = true,
                onClick = {}
            )
            SettingsItemRow(
                title = stringResource(R.string.setting_terms_of_service),
                subtitle = stringResource(R.string.setting_terms_of_service_desc),
